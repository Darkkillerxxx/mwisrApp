...
System.BigInt = function() {
  ...
  this.FromHex = function(s) {
    this.FromString(s, 16)
  }
  this.ToHex = function() {
    return this.ToString(16)
  }
  // eslint-disable-next-line
  this.FromDecimal = function(s) {
    //eslint-disable-next-line
  ...
  function initialize0() {
    // eslint-disable-next-line
    var m_maxbytes = System.BigInt.MaxBytes
...
System.BigInt._Utils = function() {
  ...
  this.ToBytes = function(x) {
    return this.ToArray(x, 256)
  }
  this.FromBytes = function(bytes) {
    return this.FromArray(bytes, 256, 0)
  }
