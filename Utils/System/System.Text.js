...
System.Char._ConvertToUtf32_2 = function(s, index) {
  ...
  if (
    index < s.length - 1 &&
    System.Char.IsHighSurrogate(s, index) &&
    System.Char.IsLowSurrogate(s, index + 1)
  ) {
...
System.Char.ConvertFromUtf32 = function(utf32) {
  ...
  if (utf32 < 0x10000) return String.fromCharCode(utf32)
...
// w[.w]@w[.w].[w]
System.Text.RegularExpressions.Templates.Email = new RegExp(
  '^[A-Z0-9_%-]+(|([.][A-Z0-9_%-]+)+)@[A-Z0-9_%-]+(|([.][A-Z0-9_%-]+)+)$',
  'i',
)
System.Text.RegularExpressions.Templates.EmailStrict = new RegExp(
  '^[A-Z0-9_%-]+(|([.][A-Z0-9_%-]+)+)@[A-Z0-9_%-]+(|([.][A-Z0-9_%-]+)+)[.](([0-9]{1,3})|([A-Z]{2,3})|(aero|coop|info|museum|name))$',
  'i',
)
...
System.Text.UTF8Encoder = function() {
  ...
  this.GetString = function(bytes, index, count) {
    ...
    if (typeof count === 'undefined') count = bytes.length - index
    var s = ''
